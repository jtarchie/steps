...
func newTestBtrfsProvider(t *testing.T) WorkspaceProvider {
	t.Helper()
	...
	p := newBtrfsProvider(&WorkspaceConfig{Strategy: "btrfs", Root: dir, Options: WorkspaceOptions{Compression: "zstd"}})
