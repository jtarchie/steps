...
func maybeCompact(ctx context.Context, llm model.LLM, req *model.LLMRequest, conv agentConversation, size *reportedSize, summary string, stalled bool) (newSummary string, newStalled bool) {
