...
func newTestCopyProvider(t *testing.T) WorkspaceProvider {
	t.Helper()

	p, err := newCopyProvider(&WorkspaceConfig{Strategy: "copy", Root: t.TempDir()})
	if err != nil {
...
// The following testProvider* helpers exercise the WorkspaceProvider/
...
func testProviderMaterializesDeclaredInputsAndOutputs(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func testProviderMutatingInputDoesNotAffectArtifact(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func testProviderCaptureAndDownstreamVisibility(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func testProviderCaptureMissingOutputErrors(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func testProviderUnknownInputErrors(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func testProviderSymlinkCopiedNotFollowed(t *testing.T, newProvider func(t *testing.T) WorkspaceProvider) {
	t.Helper()
...
func TestValidateArtifactFlowUnknownInputErrors(t *testing.T) {
	...
	cfg := &Config{Workspace: &WorkspaceConfig{Strategy: "copy"}}
	job := &Job{
		Name: "build",
		Plan: []Step{
